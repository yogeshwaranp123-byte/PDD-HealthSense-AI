...
def main():
    ...
    # Paths to the reports as requested
    e2e_path = os.path.join(repo_root, "mobile", "report", "E2E_Appium_Report_HealthSense_2026-06-11T20-15-33.xlsx")
    sec_path = os.path.join(repo_root, "mobile", "report", "Security_Vulnerability_Report_2026-06-11T07-29-57.xlsx")
